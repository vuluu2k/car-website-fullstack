                  ...
                  <ScrollToTop>
                    <Switch>
                      ...
                      <Route
                        ...
                        path="/introduce"
                        render={(props) => (
                          <Loading {...props} PageRoute="introduce" />
                        )}
                      />
                      <Route
                        exact
                        path="/products"
                        render={(props) => (
                          <Loading {...props} PageRoute="products" />
                        )}
                      />
                      <Route
                        exact
                      ...
                      <Route
                        ...
                        path="/news/:id"
                        render={(props) => (
                          <Loading {...props} PageRoute="newDetail" />
                        )}
                      />
                      <Route
                        exact
                        path="/installment"
                        render={(props) => (
                          <Loading {...props} PageRoute="installment" />
                        )}
                      />
                      <Route
                        exact
                        path="/pricelist"
                        render={(props) => (
                          <Loading {...props} PageRoute="pricelist" />
                        )}
                      />
                      <Route
                        exact
                        path="/contact"
                        render={(props) => (
                          <Loading {...props} PageRoute="contact" />
                        )}
                      />
                      <Route
                        exact
                      ...
                      <Route
                        ...
                        path="/products/:slug"
                        render={(props) => (
                          <Loading {...props} PageRoute="productDetail" />
                        )}
                      />
                      <Route
                        exact
                        path="/admin"
                        render={(props) => (
                          <Admin {...props} AdminRoute="AdminLogin" />
                        )}
                      />
                      <ProtectedRoute
                        exact
