    ...
    return ( <
        ...
        Row className = "row-cols-1 row-cols-md-2 row-cols-lg-3 mx-auto" > {
            news.map(news => ( <
                ...
                Card.Title as = "h6"
                style = {
                    { height: '40px', textTransform: 'uppercase' } } > { news.titleNew } < /Card.Title>

                <
                Card.Img style = {
                    { height: '200px' } }
                variant = "top"
                src = { news.imageNewUrl }
                /> <
                ...
                size = "sm" > < i className = "far fa-eye" > < /i></Button >
                <
                Button style = {
                    { marginLeft: '5%' } }
                variant = "outline-info"
                size = "sm" > < i className = "fas fa-pencil-alt" > < /i></Button >
                <
                Button style = {
                    { marginLeft: '5%' } }
                variant = "outline-danger"
                size = "sm" > < i className = "fas fa-trash-alt" > < /i></Button >
                <
                /div> <
                div className = "" >
